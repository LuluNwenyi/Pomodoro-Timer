...
canvas=Canvas(width=250, height=200, bg=CREAM, highlightthickness=0)  #highlightthickness takes away the border around the canvas
...
start_button = Button(text="Start", bg= CREAM, fg=BROWN, highlightthickness=2, highlightcolor=CREAM, highlightbackground=CREAM, command=start_timer)
reset_button = Button(text="Reset", bg= CREAM, fg=BROWN, highlightthickness=2, highlightcolor=CREAM, highlightbackground=CREAM, command=reset_timer)
